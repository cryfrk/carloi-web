...
const DEFAULT_SHARE_BASE_URL = 'https://www.carloi.com';
...
export const webEnv = {
  ...
  shareBaseUrl: requireEnv(process.env.NEXT_PUBLIC_SHARE_BASE_URL, DEFAULT_SHARE_BASE_URL),
  ...
  privacyUrl: requireEnv(
    ...
    `${requireEnv(process.env.NEXT_PUBLIC_SHARE_BASE_URL, DEFAULT_SHARE_BASE_URL)}/privacy`,
  ),
  termsUrl: requireEnv(
    process.env.NEXT_PUBLIC_TERMS_URL,
    `${requireEnv(process.env.NEXT_PUBLIC_SHARE_BASE_URL, DEFAULT_SHARE_BASE_URL)}/terms`,
  ),
};
